...
final class ValueTests: XCTestCase {
    func testBoolConversions() throws {
        // Strict mode
        XCTAssertEqual(Bool(Value.bool(true), strict: true), true)
        XCTAssertEqual(Bool(Value.bool(false), strict: true), false)
        XCTAssertNil(Bool(Value.int(1), strict: true))
        XCTAssertNil(Bool(Value.string("true"), strict: true))
        ...
        XCTAssertNil(Bool(Value.string("invalid"), strict: false))
    }
